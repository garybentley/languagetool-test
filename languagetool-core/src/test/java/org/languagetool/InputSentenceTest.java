...
public class InputSentenceTest {
  ...
  public void test() {
    ...
    InputSentence inputSentence1a = new InputSentence("foo", lang, lang,
            ...
            new HashSet<>(Arrays.asList("ID2")), new HashSet<>(Arrays.asList(new CategoryId("C2"))), userConfig1, mode);
    ...
    InputSentence inputSentence1bUserConfig2 = new InputSentence("foo", lang, lang,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
            new HashSet<>(Arrays.asList("ID2")), new HashSet<>(Arrays.asList(new CategoryId("C2"))), userConfig2, mode);
    ...
    InputSentence inputSentence1aOtherMode = new InputSentence("foo", lang, lang,
            new HashSet<>(Arrays.asList("ID1")), new HashSet<>(Arrays.asList(new CategoryId("C1"))),
            new HashSet<>(Arrays.asList("ID2")), new HashSet<>(Arrays.asList(new CategoryId("C2"))), userConfig1, JLanguageTool.Mode.TEXTLEVEL_ONLY);
