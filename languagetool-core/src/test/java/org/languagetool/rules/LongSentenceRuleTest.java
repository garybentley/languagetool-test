...
public class LongSentenceRuleTest {
  ...
  public void testMatch() throws Exception {
    ...
    LongSentenceRule rule = new LongSentenceRule(lang.getMessageBundle());
    ...
    LongSentenceRule shortRule = new LongSentenceRule(lang.getMessageBundle(), 6);
//    shortRule.setDefaultValue(6);
  ...
  private void assertNoMatch(String input, LongSentenceRule rule, JLanguageTool lt) throws Exception {
    assertThat(rule.match(lt.getAnalyzedSentence(input)).length, is(0));
  }

  private void assertMatch(String input, int from, int to, LongSentenceRule rule, JLanguageTool lt) throws Exception {
