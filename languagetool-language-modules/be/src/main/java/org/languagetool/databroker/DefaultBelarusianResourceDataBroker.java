...
public class DefaultBelarusianResourceDataBroker extends DefaultResourceDataBroker implements BelarusianResourceDataBroker {
    ...
    public DefaultBelarusianResourceDataBroker(Belarusian lang, ClassLoader classLoader) throws Exception {
