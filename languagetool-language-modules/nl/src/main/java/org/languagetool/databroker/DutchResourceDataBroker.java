...
public interface DutchResourceDataBroker extends ResourceDataBroker {
    ...
    List<Map<String, String>> getWrongWords() throws Exception;
    ...
    List<PreferredWordRuleWithSuggestion> getPreferredWordRules() throws Exception;
