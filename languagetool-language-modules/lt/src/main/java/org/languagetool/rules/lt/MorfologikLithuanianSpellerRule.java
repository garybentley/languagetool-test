...
public final class MorfologikLithuanianSpellerRule extends MorfologikSpellerRule {
  ...
  // GTODO private static final String RESOURCE_FILENAME = "/lt/hunspell/lt_LT.dict";

  public MorfologikLithuanianSpellerRule(ResourceBundle messages, Lithuanian language, UserConfig userConfig, Set<Dictionary> dictionaries, List<String> ignoreWords) throws Exception {
