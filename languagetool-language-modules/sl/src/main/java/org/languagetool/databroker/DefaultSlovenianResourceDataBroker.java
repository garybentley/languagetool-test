...
public class DefaultSlovenianResourceDataBroker extends DefaultResourceDataBroker implements SlovenianResourceDataBroker {
    ...
    public DefaultSlovenianResourceDataBroker(Slovenian lang, ClassLoader classLoader) throws Exception {
