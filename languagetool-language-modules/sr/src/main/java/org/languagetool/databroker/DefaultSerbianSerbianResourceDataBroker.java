...
public class DefaultSerbianSerbianResourceDataBroker extends DefaultSerbianResourceDataBroker {
     ...
     */
    public static String BINARY_DICT_FILE_NAME = "%1$s/dictionary/ekavian/serbian_hunspell.dict";

    public static String PLAIN_TEXT_BASE_SPELLING_FILE_NAME = "%1$s/dictionary/ekavian/spelling.txt";

    public static String IGNORE_WORDS_FILE_NAME = "%1$s/dictionary/ekavian/ignored.txt";
    public static String PROHIBITED_WORDS_FILE_NAME = "%1$s/dictionary/ekavian/prohibit.txt";

    public static String WORD_TAGGER_DICT_FILE_NAME = "%1$s/dictionary/ekavian/serbian.dict";

    public static String SYNTHESIZER_WORD_TAGS_FILE_NAME = "%1$s/dictionary/serbian_synth_tags.txt";
    public static String SYNTHESIZER_ADDED_TAGS_FILE_NAME = "%1$s/dictionary/ekavian/added.txt";
    public static String STEMMER_DICT_FILE_NAME = "%1$s/dictionary/ekavian/serbian_synth.dict";

    public static String WORD_TAGGER_ADDED_WORDS_FILE_NAME = "%1$s/dictionary/ekavian/added.txt";
    public static String WORD_TAGGER_REMOVED_WORDS_FILE_NAME = "%1$s/dictionary/ekavian/removed.txt";

    public static String STYLE_WRONG_WORDS_FILE_NAME = "%1$s/ekavian/replace-style.txt";
    public static String GRAMMAR_WRONG_WORDS_FILE_NAME = "%1$s/ekavian/replace-grammar.txt";
    ...
    public DefaultSerbianSerbianResourceDataBroker(SerbianSerbian lang, ClassLoader classLoader) throws Exception {
    ...
    public Tagger getTagger() throws Exception {
        return new EkavianTagger(getWordTaggerDictionary(), getWordTagger(), getCaseConverter());
    }
