...
public interface SerbianResourceDataBroker extends ResourceDataBroker {
    ...
    Map<String, List<String>> getStyleWrongWords() throws Exception;
    Map<String, List<String>> getGrammarWrongWords() throws Exception;
