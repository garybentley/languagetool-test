...
public class AustralianEnglish extends English {
    ...
    public static final String COUNTRY_ID = "AU";
  ...
  public MorfologikAustralianSpellerRule createMorfologikSpellerRule(ResourceBundle messages, UserConfig userConfig) throws Exception {
      return new MorfologikAustralianSpellerRule(getUseMessages(messages), this, userConfig, getUseDataBroker().getDictionaries(userConfig),
