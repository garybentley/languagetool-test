...
public class SouthAfricanEnglish extends English {
    ...
    public static final String COUNTRY_ID = "ZA";
  ...
  public MorfologikSouthAfricanSpellerRule createMorfologikSpellerRule(ResourceBundle messages, UserConfig userConfig) throws Exception {
      return new MorfologikSouthAfricanSpellerRule(getUseMessages(messages), this, userConfig, getUseDataBroker().getDictionaries(userConfig),
