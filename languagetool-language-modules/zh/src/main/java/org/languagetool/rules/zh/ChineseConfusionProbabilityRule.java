...
public class ChineseConfusionProbabilityRule extends ConfusionProbabilityRule {
  ...
  public ChineseConfusionProbabilityRule(ResourceBundle messages, LanguageModel languageModel, Chinese language, Map<String,List<ConfusionSet>> confusionSets) {
