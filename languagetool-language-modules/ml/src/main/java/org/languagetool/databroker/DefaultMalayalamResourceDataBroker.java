...
public class DefaultMalayalamResourceDataBroker extends DefaultResourceDataBroker implements MalayalamResourceDataBroker {
     ...
     * For ml_IN this would become: lt/hunspell/ml_IN.dict
     */
    ...
    public static String WORD_TAGGER_DICT_FILE_NAME = "%1$s/malayalam.dict";
    ...
    public DefaultMalayalamResourceDataBroker(Malayalam lang, ClassLoader classLoader) throws Exception {
    ...
    public Tagger getTagger() throws Exception {
        return new MalayalamTagger(getWordTaggerDictionary(), getWordTagger(), getCaseConverter());
    }
